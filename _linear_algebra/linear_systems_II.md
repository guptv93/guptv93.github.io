...
slug: non-square
item_num: 3
excerpt: Till now we have only worked with square matrices and linear systems with as many equations as the number of unknowns. Now we step into the realm of non-square matrices. These notes are majorly derived from MIT OCW 18.06 Series.
---
...
<center><img alt="Reduced Row Echelon Form" src="/assets/images/linear_algebra/linear_systems_II.assets/image-20200608173335014.png"/></center>
